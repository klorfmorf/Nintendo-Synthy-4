...
//#include "Src/Games/NS4JLeagueElevenBeat1997Files.inl"
...
//#include "Src/Games/NS4AllStarBaseball2001Files.inl"
...
//#include "Src/Games/NS4MajorLeagueBaseballFeaturingKenGriffeyJrFiles.inl"
...
#define NS4_ROOT_FOLDER					u8"C:\\My Projects\\MIDIWorks\\Exports\\"
	...
	for ( size_t F = 0; F < sizeof( mfFiles ) / sizeof( mfFiles[0] ); ++F ) {
		...
		ns4::CMidiFile::m_sSettings.bAutoTrackOffsetDuringLoad = false;

#ifdef NS4_AUTO_OFFSET_TRACK_CHAN
		ns4::CMidiFile::m_sSettings.bAutoTrackOffsetDuringLoad = NS4_AUTO_OFFSET_TRACK_CHAN;
#endif	// NS4_AUTO_OFFSET_TRACK_CHAN
